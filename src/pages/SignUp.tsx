...
const features = [
  { icon: PieChart, color: "bg-info-bg text-info-foreground", title: "Real-time Dashboard", desc: "Get a clear overview of your business financials." },
  { icon: Landmark, color: "bg-success-bg text-success-foreground", title: "Bank Reconciliation", desc: "Automatically reconcile transactions and save time." },
  { icon: FileText, color: "bg-purple-bg text-purple-foreground", title: "Invoice & Payments", desc: "Create invoices, track payments and get paid faster." },
  { icon: BarChart3, color: "bg-warning-bg text-warning-foreground", title: "Powerful Reports", desc: "Make data-driven decisions with smart financial reports." },
]
      ...
      <div className="flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          <div className="mb-8 flex items-center gap-2.5">
            <FinovoMark />
            <div>
              <p className="text-xl leading-tight font-bold text-foreground">Finovo</p>
              <p className="text-muted-foreground text-xs">Smart Accounting for Modern Businesses</p>
            </div>
          </div>

          <h1 className="text-2xl font-bold text-foreground">Create your account 🚀</h1>
          <p className="text-muted-foreground mt-1 mb-7 text-sm">Start your 14-day free trial. No credit card required.</p>
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Your name" className="h-11 pl-9" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Your company" className="h-11 pl-9" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="Enter your work email" className="h-11 pl-9" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input type={showPassword ? "text" : "password"} placeholder="Create password" className="h-11 px-9" />
                  <button type="button" onClick={() => setShowPassword((s) => !s)} className="text-muted-foreground absolute top-1/2 right-3 -translate-y-1/2">
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="text-muted-foreground absolute top-1/2 left-3 size-4 -translate-y-1/2" />
                  <Input type={showConfirm ? "text" : "password"} placeholder="Confirm password" className="h-11 px-9" />
                  <button type="button" onClick={() => setShowConfirm((s) => !s)} className="text-muted-foreground absolute top-1/2 right-3 -translate-y-1/2">
            ...
            <Button size="lg" className="mt-1 h-11 w-full text-[15px]">Create free account</Button>
          </form>
      ...
      <div className="from-primary/[0.06] to-primary/15 relative hidden overflow-hidden bg-gradient-to-br via-transparent lg:flex lg:flex-col lg:justify-center lg:px-16 xl:px-20">
        ...
        <div className="max-w-lg">
          <h2 className="text-4xl leading-tight font-bold text-foreground xl:text-[42px]">
            Join thousands of businesses <span className="text-primary">growing with Finovo.</span>
          </h2>
          <p className="text-muted-foreground mt-4 text-base">
            Set up your account in minutes and start managing invoices, expenses and taxes with confidence.
          </p>
          ...
          <div className="bg-card mt-8 flex items-center gap-3 rounded-xl border p-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground text-xs">Your data is encrypted and secure with enterprise-grade protection.</p>
            </div>
          </div>
        </div>
